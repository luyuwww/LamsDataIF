...
set SUN_JAVA_HOME=C:\Program Files\jdk7u67x64
...
if "%JAVA_VENDOR%"=="Oracle" (
	...
	if "%JAVA_VENDOR%"=="Sun" (
		...
		set JAVA_VENDOR=Sun
		set JAVA_HOME=C:\Program Files\jdk7u67x64
	)
)
...
set DOMAIN_HOME=D:\Oracle\Middleware\user_projects\domains\thams_domain
for %%i in ("%DOMAIN_HOME%") do set DOMAIN_HOME=%%~fsi

set LONG_DOMAIN_HOME=D:\Oracle\Middleware\user_projects\domains\thams_domain
...
set JAVA_OPTIONS=%JAVA_OPTIONS% -Dorg.apache.cxf.stax.allowInsecureParser=1
